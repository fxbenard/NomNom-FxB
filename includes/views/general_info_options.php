	...
	<div id="nomnom_tweet_wrap">
		<div id="nomnom_tweet">
	<b><?php _e('Follow me on Twitter and Share on Facebook!','nomnom');?></b><br><br>
		<p><a href="https://twitter.com/earthjellyfish" class="twitter-follow-button"> @ZeaksBlog</a>
...
<br>
	<font size="3"><b><?php _e('Support NomNom','nomnom');?></b></font>
	<p><?php _e('If you enjoy this theme and want to support my time and effort, you can help me out by donating. Any amount big or small, all donations are appreciated.','nomnom');?>
